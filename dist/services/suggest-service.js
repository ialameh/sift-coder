...
export class SuggestService {
     ...
     */
    async suggestRequest(userRequest, context) {
     ...
     */
    scoreCommand(cmdName, cmdData, analysis, context) {
        let score = 0;
        const reasons = [];
     ...
     */
    extractCommandKeywords(cmdName, content) {
        const keywords = [];
