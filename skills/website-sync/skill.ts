 ...
 */
export async function detectChanges(projectPath: string, websitePath: string): Promise<{
  success: boolean;
 ...
 */
export function getSyncStrategy(websiteType: WebsiteType): {
  defaultMode: SyncMode;
  description: string;
  strategies: {[key in CodebaseChange["type"]]: SyncMode};
} {
  const strategies: {[key: string]: {defaultMode: SyncMode; description: string; strategies: any}} = {
    documentation: {
      defaultMode: "auto",
 ...
 * Check sync status
 */
export async function checkSyncStatus(projectPath: string, websitePath: string): Promise<{
  success: boolean;
  status?: {
...
const checkSyncStatusTool: Tool = {
